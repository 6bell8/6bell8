...
단순히 화면만 만드는 개발자가 아니라,  
서비스가 실제로 어떻게 동작하고 운영되는지까지 고려하며 개발하는 것을 중요하게 생각합니다.

실무에서는 다음과 같은 업무를 주로 수행했습니다.

- React 기반 관리자 페이지 및 업무용 웹 화면 개발
- RESTful API 연동 및 인터페이스 정의
- 동적노드 로직 구성 및 서비스 운영 지원
